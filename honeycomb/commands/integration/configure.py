...
def configure(ctx, integration, arg, show_args, editable):
    ...
    integration_args = plugin_utils.parse_plugin_args(arg, config_utils.get_config_parameters(integration_path))
